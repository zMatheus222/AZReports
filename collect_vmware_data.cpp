...
inline vector<QString> collect_vmware_data(string item){
    ...
    vector<string> vmwares = txt_vetorize("D:\\USE\\Projects\\C++\\AZTests\\txt_files\\wiki_vmwares.txt");

    qDebug() << "vmwares wiki:\n";
    for(string line : vmwares){
        qDebug() << line << "\n";
    }
